...
public interface Extractor {
	 ...
	 * @param url				待处理文章载体的URL路径
	 * @throws ExtractException	文章抽取中出现的异常错误
	 */
	...
	/**
	 * 获取当前文章中所有url；
	 * 1. 网络url，例如：http://10.0.125.60/web/
	 * 2. 本地url，例如：file://C:\Documents and Settings\All Users\Documents
	 * @return					Url列表
	 */
	public List<String> getUrls();
	/**
	 * 将当前Url和一个相对Url进行拼接
	 * <br>例如：1. 	"http://10.0.125.60/web/"和"./index.php?mods=forumdisplay&forumid=2"
	 * <br>			--> "http://10.0.125.60/web/index.php?mods=forumdisplay&forumid=2"
	 * <br>		2.	"http://10.0.125.60/web/index.php?mods=forumdisplay&forumid=2"和"../tools/"
	 * <br>			--> "http://10.0.125.60/tools/"
	 * <br>		若相对url以http和ftp协议开头，则直接返回相对url
	 * <br>		若相对url开头无任何特殊符号，则与开头为“./”的url处理方式相同
	 * @param originalUrl	原始Url
	 * @param oppositeUrl	相对Url
	 * @return					拼接好的Url字串
	 */
