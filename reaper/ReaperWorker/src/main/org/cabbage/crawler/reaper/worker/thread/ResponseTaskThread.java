 ...
 * 
 */
public class ResponseTaskThread extends Thread {
	private static final Log LOGGER = LogFactory.getLog(ResponseTaskThread.class);
	 ...
	 * 
	 */
	public ResponseTaskThread(ManagerHandle managerHandle) {
